...
const {
  updateUser, getWeightHistory, addWeightEntry,
  getUpdates, addUpdate, getMeetings, addMeeting,
...
router.post('/messages', async (req, res) => {
  try {
    ...
    const message = addMessage(req.user.id, 'coach-shalhevet', text.trim(), 'client');
